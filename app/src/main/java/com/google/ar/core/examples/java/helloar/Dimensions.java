...
public class Dimensions extends AppCompatActivity {
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(fl_measurement != 0.0f)
                    ...
                    Toast.makeText(Dimensions.this, "Make a measurement before saving", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        btn_share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(arl_saved.size() > 0){
                    ...
                    Toast.makeText(Dimensions.this, "Save measurements before sharing", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void saveDialog() {
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(Dimensions.this);
        ...
        mBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if(et_measure.length() != 0){
                    ...
                    Toast.makeText(Dimensions.this, "Title can't be empty", Toast.LENGTH_SHORT).show();
            }
        });
